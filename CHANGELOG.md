...
## 2026-05-28 v6.7.16
- Скорректировано условие проверки наличия подписки у пользователя

## 2026-05-15 v6.7.15
- Исправлена ошибка при обработке платежей из CRM

## 2026-05-14 v6.7.14
- Исправлено подключение jQuery в модуле для совместимости с новыми версиями Битрикс
